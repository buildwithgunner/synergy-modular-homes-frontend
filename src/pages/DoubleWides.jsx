...
export default function DoubleWides() {
  ...
  useEffect(() => {
    const fetchHomes = async () => {
      try {
        let res = await fetch(`${API_BASE}/homes?type=Double Wide`)
        ...
        const filtered = allHomes.filter((home) => {
          ...
          return (
            type.includes('double wide') ||
            type.includes('double-wide') ||
            type.includes('doublewide')
          )
        })
    ...
    <div className="min-h-screen bg-[#F8F7F4]">
      ...
      <section className="bg-[#0B1C33] text-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-3xl sm:text-5xl font-extrabold mb-4">Double Wide Homes</h1>
          <p className="text-slate-300 text-lg max-w-2xl mx-auto">
            More space, more comfort. Double-wide homes give you the feel of a traditional house
            with the affordability of modular housing.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-14">
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-[#0B1C33] mb-3">Why Choose a Double Wide?</h2>
          <p className="text-slate-600 max-w-3xl">
            Double-wides offer larger living areas, multiple bedrooms, and a more traditional home feel.
            Ideal for families who want extra space without the high cost of site-built homes.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-slate-500">
            No Double Wide homes available at the moment.
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {homes.map((home) => (
              ...
              >
                <div className="h-56 overflow-hidden">
                  <img
                    src={getImageUrl(home.image) || 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800'}
                    alt={home.title}
