        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="admin@mobilehomes.com"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                value={form.password}
                onChange={handleChange}
                className="w-full border rounded-xl px-4 py-3 pr-12 text-sm focus:ring-2 focus:ring-red-500 outline-none"
                placeholder="••••••••"
              />
              <button
                type="button"
